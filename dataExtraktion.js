...
<tbody>
  ...
  <tr>
    ...
    <div class="row"> 
      ...
      <div class="col-3 text-end">
        <button onclick="saveChanges('time')" type="button" class="btn btn-success btn-sm confirmGroup">
        ${saveButtonIcon}
        </button>
...
<tbody id="productList">`;
    ...
    if (!(match[1].includes(sumMatch[0]))) {
      ...
      <td>
        <button onclick="saveChanges('product${i}'); saveChanges('price${i}'); updateReceiptSum('pricesForSum');" type="button"
          class="btn btn-success btn-sm confirmGroup">
          ${saveButtonIcon}
        </button>
  ...
  <td>
    <button onclick="addEmptyProductRow()" type="button"
  ...
  <td>
    <button onclick="confirmAllFields();" type="button" class="btn btn-success btn-sm">Alle Felder bestätigen</button>
  </td>
</tr>
</tbody>
<tfoot>
